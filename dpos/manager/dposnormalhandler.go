...
func (h *DPOSNormalHandler) ProcessAcceptVote(id peer.PID, p *payload.DPOSProposalVote) (succeed bool, finished bool) {
	...
	} else if bytes.Equal(currentProposal.Bytes(), p.ProposalHash.Bytes()) {
...
func (h *DPOSNormalHandler) tryGetCurrentProposal(id peer.PID, p *payload.DPOSProposalVote) (com.Uint256, bool) {
...
func (h *DPOSNormalHandler) ChangeView(firstBlockHash *common.Hash) {
