...
func (h *History) Append(height uint64, execute func(), rollback func()) {
...
func (h *History) Commit(height uint64) {
...
func (h *History) SeekTo(height uint64) error {
	// check whether history is enough to seek
	limitHeight := h.height - uint64(len(h.changes))
...
func (h *History) RollbackTo(height uint64) error {
