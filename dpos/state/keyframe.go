...
type StateKeyFrame struct {
	...
	SpecialTxHashes          map[common.Hash]struct{}
	PreBlockArbiters         map[string]struct{}
	ProducerDepositMap       map[com.Uint168]struct{}

	EmergencyInactiveArbiters map[string]struct{}
	VersionStartHeight        uint64
	VersionEndHeight          uint64
}

// RewardData defines variables to calculate reward of a round
type RewardData struct {
	OwnerProgramHashes          []*com.Uint168
	CandidateOwnerProgramHashes []*com.Uint168
	OwnerVotesInRound           map[com.Uint168]uint64
	TotalVotesInRound           uint64
}
...
func (s *StateKeyFrame) snapshot() *StateKeyFrame {
	state := StateKeyFrame{
		...
		ProducerDepositMap:       make(map[com.Uint168]struct{}),
	}
...
func (s *StateKeyFrame) SerializeHashSet(vmap map[common.Hash]struct{},
...
func (s *StateKeyFrame) DeserializeHashSet(
	r io.Reader) (vmap map[common.Hash]struct{}, err error) {
	//var count uint64
...
func (s *StateKeyFrame) SerializeDIDSet(vmap map[com.Uint168]struct{},
	w io.Writer) (err error) {
	//if err = common.WriteVarUint(w, uint64(len(vmap))); err != nil {
	//	return
	//}
...
func (s *StateKeyFrame) DeserializeDIDSet(
	r io.Reader) (vmap map[com.Uint168]struct{}, err error) {
	//var count uint64
	//if count, err = common.ReadVarUint(r, 0); err != nil {
	//	return
	//}
...
func NewRewardData() *RewardData {
	return &RewardData{
		OwnerProgramHashes:          make([]*com.Uint168, 0),
...
func copyHashSet(src map[common.Hash]struct{}) (
	dst map[common.Hash]struct{}) {
	dst = map[common.Hash]struct{}{}
	for k := range src {
		dst[k] = struct{}{}
	}
...
func copyDIDSet(src map[com.Uint168]struct{}) (
	dst map[com.Uint168]struct{}) {
	dst = map[com.Uint168]struct{}{}
	for k := range src {
		dst[k] = struct{}{}
	}
