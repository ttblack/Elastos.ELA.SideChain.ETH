...
func (s *PrivateAccountAPI) signTransaction(ctx context.Context, args *SendTxArgs, passwd string) (*types.Transaction, error) {
	...
	return wallet.SignTxWithPassphrase(account, passwd, tx, s.b.ChainConfig().GetChainIDByHeight(s.b.CurrentBlock().Number()))
}
...
//
// https://github.com/elastos/Elastos.ELA.SideChain.ETH/wiki/Management-APIs#personal_sign
...
//
// https://github.com/elastos/Elastos.ELA.SideChain.ETH/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicBlockChainAPI) ChainId() *hexutil.Big {
	...
	return (*hexutil.Big)(s.b.ChainConfig().GetChainIDByHeight(number))
}
...
func (s *PublicBlockChainAPI) SendInvalidWithdrawTransaction(ctx context.Context, signature string, hash string) error {
	...
	if tx == nil || err != nil {
		msg := fmt.Sprintf("not found withdraw tx, txid:%s", hash)
		log.Error(msg)
...
func (s *PublicTransactionPoolAPI) sign(addr common.Address, tx *types.Transaction) (*types.Transaction, error) {
	...
	return wallet.SignTx(account, tx, s.b.ChainConfig().GetChainIDByHeight(s.b.CurrentBlock().Number()))
}
...
func (s *PublicTransactionPoolAPI) SendTransaction(ctx context.Context, args SendTxArgs) (common.Hash, error) {
	...
	signed, err := wallet.SignTx(account, tx, s.b.ChainConfig().GetChainIDByHeight(s.b.CurrentBlock().Number()))
	if err != nil {
		return common.Hash{}, err
	}
	return SubmitTransaction(ctx, s.b, signed)
...
//
// https://github.com/elastos/wiki/wiki/JSON-RPC#eth_sign
